...
#### 1. [`test/osiris/src/components/ProvenanceBadge.tsx`](file:///e:/Projects/IOT+Ml+EDA/test/osiris/src/components/ProvenanceBadge.tsx) *(NEW)*
...
#### 2. [`test/osiris/src/components/ProvenanceBadge.test.ts`](file:///e:/Projects/IOT+Ml+EDA/test/osiris/src/components/ProvenanceBadge.test.ts) *(NEW)*
- **Purpose:** Unit test suite covering provenance classification, fallback handling, color assignment, and HTML string generation.

#### 3. [`test/osiris/src/components/FeedHealthIndicator.tsx`](file:///e:/Projects/IOT+Ml+EDA/test/osiris/src/components/FeedHealthIndicator.tsx) *(NEW)*
...
#### 4. [`test/osiris/src/components/FeedHealthIndicator.test.ts`](file:///e:/Projects/IOT+Ml+EDA/test/osiris/src/components/FeedHealthIndicator.test.ts) *(NEW)*
- **Purpose:** Unit tests validating feed health response parsing and adapter status mapping.

#### 5. [`test/osiris/src/components/OsirisMap.tsx`](file:///e:/Projects/IOT+Ml+EDA/test/osiris/src/components/OsirisMap.tsx) *(MODIFIED)*
- **Changes Made:**
...
#### 6. [`test/osiris/src/hooks/useSSEPositions.ts`](file:///e:/Projects/IOT+Ml+EDA/test/osiris/src/hooks/useSSEPositions.ts) *(MODIFIED)*
- **Changes Made:**
...
#### 7. [`test/osiris/src/lib/nexafreight/client.ts`](file:///e:/Projects/IOT+Ml+EDA/test/osiris/src/lib/nexafreight/client.ts) *(MODIFIED)*
- **Changes Made:**
...
#### 8. [`test/osiris/src/lib/nexafreight/index.ts`](file:///e:/Projects/IOT+Ml+EDA/test/osiris/src/lib/nexafreight/index.ts) *(MODIFIED)*
- **Changes Made:**
  - Exported `getFeedHealth` from the public package barrel export.

#### 9. [`test/osiris/src/lib/nexafreight/client.test.ts`](file:///e:/Projects/IOT+Ml+EDA/test/osiris/src/lib/nexafreight/client.test.ts) *(MODIFIED)*
- **Changes Made:**
  - Added unit test verifying `nexaClient.getFeedHealth()` requests `GET /api/map/feed-health` with the `Authorization: Bearer` header.

#### 10. [`test/osiris/src/app/page.tsx`](file:///e:/Projects/IOT+Ml+EDA/test/osiris/src/app/page.tsx) *(MODIFIED)*
- **Changes Made:**
...
#### 11. [`test/osiris/src/app/globals.css`](file:///e:/Projects/IOT+Ml+EDA/test/osiris/src/app/globals.css) *(MODIFIED)*
- **Changes Made:**
