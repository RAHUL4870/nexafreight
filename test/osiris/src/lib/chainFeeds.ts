// Sanctions feed removed — OFAC SDN data source discontinued in this build.
 ...
 */
async function collectSanctionedWallets(_days: number): Promise<{ items: SanctionedWallet[]; degraded: string[] }> {
  // OFAC SDN feed removed — returns empty.
  return { items: [], degraded: [] };
}
