...
import { isRateLimited, getClientIp, safeFetch } from '@/lib/ssrf-guard';
...
export async function GET(req: Request) {
  ...
  try {
    ...
    // Sanctions cross-check removed (OFAC data source discontinued in this build)
    results.sanctions_match = null;
